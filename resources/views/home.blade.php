<x-navbar></x-navbar>
    ...
    <div class="flex flex-row lg:gap-4 sm w-full justify-center lg:text-lg">
        ...
        <div class="sm:mt-[50px] sm:w-[300px] lg:w-[400px] lg:mt-[100px]">
            <h1 class="text-gray-700 md:text-3xl xl:text-4xl text-center py-3 ">
                About ROSE
            </h1>
            <p class="text-2xl">We are Rose Import Export Co.,Ltd who deliver your goods from Thailand's airports and seaports to their destination quickly and without damage.</p>
            <br>
            <a class="btn1" href="/aboutus"> Read More </a>
        </div>
        <img class="object-fill w-[400px]" src="/images/Rose Pf1.jpg" alt="">
    </div>
