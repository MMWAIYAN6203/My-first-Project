<x-layout>
    ...
    <div class="relative my-[20px] xl:ms-[30vh] lg:ms-[10vh] md:ms-[24vh] sm:ms-[17vh] xl:mb-[35vh]">
        <div class="card-container1 w-[80vh] lg:w-[60vh] md:w-[50vh] sm:w-[45vh] sm:h-[35vh]">
            <div class="card1 ">
                <div class="img-content1">
                    <h1 class="transportation xl:text-2xl lg:text-lg md:text-md sm:text-sm font-semibold">Transit
        ...
        <img class="absolute inset-0 xl:w-[80vh] lg:w-[60vh] md:w-[50vh] sm:w-[45vh] lg:h-[] md:h-[] sm:h-[35vh] xl:h-[40vh] object-fill rounded-xl xl:ms-[60vh] xl:mt-[180px] lg:ms-[40vh] lg:mt-[150px] md:ms-[20vh] md:mt-[130px] sm:ms-[20vh] sm:mt-[130px] z-[-1]"
            src="/images/Transit_container.jpg" alt="">
    </div>
    <!-- custom clearance -->
    <div class="flex flex-row gap-5 lg:mt-[180px] md:mt-[180px] sm:mt-[180px] p-1">
        <img class="object-fill w-[60vh]  sm:w-[50vh] sm:h-[30vh] xl:h-[45vh] xl:ms-[30vh]"
            src="/images/custom-clearance.jpg" alt="img of clearance">
        <div>
    ...
    <div class="flex flex-row justify-evenly">
        ...
        <img class="object-fill xl:w-[90vh] xl:h-[100vh] lg:w-[55vh] lg:h-[85vh] md:w-[50vh] md:h-[123vh] sm:w-[40vh] sm:h-[110vh] xl:mt-[130px] lg:mt-[87px] md:mt-[83px] sm:mt-[85px]"
            src="/images/import_export.jpg" alt="">
    </div>

    <!-- Warehouse service -->
    <div class="relative">
        <img class="xl:ms-[35vh] xl:mt-[40vh] lg:ms-[10vh] lg:mt-[25vh] md:ms-[10vh] md:mt-[25vh] sm:ms-[5vh] sm:mt-[25vh] rounded-xl xl:w-[70vh] lg:w-[60vh] md:w-[55vh] sm:w-[50vh]"
            src="/images/warehouse.jpg" alt="">
        <div
            class="card3 w-[80vh] h-[43vh] xl:w-[80vh] xl:h-[43vh] lg:w-[55vh] lg:h-[35vh] md:w-[55vh] md:h-[42vh] sm:w-[50vh] sm:h-[38vh] text-white xl:ms-[100vh] lg:ms-[55vh] md:ms-[55vh] sm:ms-[45vh] absolute inset-0 z-[1] xl:mt-[-35vh] sm:mt-[-25vh]">
            <h1
                class="xl:text-3xl lg:text-3xl md:text-2xl sm:text-xl py-[15px] sm:py-[10px] md:py-[15px] text-center font-semibold">
