<x-layout>
    ...
    <div class="my-[50px] mb-[60px]  p-[0px]  ">
        <div class="card-container1 m-auto  w-[280px] h-[220px] xl:w-[67vh] xl:h-[35vh] lg:w-[50vh] lg:h-[vh] md:w-[50vh] md:h-[35vh] sm:w-[45vh] sm:h-[35vh]">
            <div class="card1 ">
                ...
                <div class="content1 w-full">
                    <p class="heading1 w-full leading-4 xl:leading-6  lg:leading-6  md:leading-5 text-[9px] xl:text-lg lg:text-lg md:text-[12px] sm:text-[12px] pt-2">
    ...
    <div class="flex flex-row justify-evenly">
        <div class="flex flex-col gap-[60px] my-[50px] md:my-[60px] lg:my-[60px] xl:my-[60px]">
            <div class="card2 w-[300px] h-[180px] sm:w-[50vh] md:w-[50vh] md:h-[42vh] lg:w-[55vh] lg:h-[40vh] xl:w-[65vh] xl:h-[55vh] ">
                <div class="content2 p-[20px] text-black sm:p-[30px] md:p-[20px] lg:p-[25px] xl:p-[36px] w-full h-full">
                    ...
                    <p class="para {{ app()->getLocale() == 'thai' ? 'large-font' : 'normal-font' }} mt-[-10px] leading-4 xl:leading-9 lg:leading-8 md:leading-6 xl:text-lg lg:text-lg md:text-[12px] sm:text-[12px]">
            ...
            <div class="card2 w-[300px] h-[200px] sm:w-[50vh] sm:h-[50vh] md:w-[50vh] md:h-[54vh] lg:w-[55vh] lg:h-[48vh] xl:w-[65vh] xl:h-[75vh]">
                <div class="content2 p-[20px] text-black sm:p-[30px] md:p-[20px] lg:p-[25px] xl:p-[36px] w-full h-full">
                    <h1 class="text-md xl:text-2xl lg:text-2xl md:text-xl sm:text-xl font-semibold">{{__("Export Service !") }}</h1>
                    <p class="para {{ app()->getLocale() == 'thai' ? 'large-font' : 'normal-font' }} mt-[-10px] leading-4 xl:leading-9 lg:leading-8 md:leading-6 xl:text-lg lg:text-[16px] md:text-[12px] sm:text-[12px]">
    ...
    <div class="">
        ...
        <div class="card3 m-auto w-[300px] h-[220px] xl:w-[70vh] xl:h-[48vh] lg:w-[65vh] lg:h-[42vh] md:w-[55vh] md:h-[43vh] text-white">
