...
<div class="relative">
  ...
  <div class="absolute inset-0 z-[1] my-[5vh] text-black mx-[30px] lg:mt-[30px] sm:mt-[-10px] mt-[-5px] md:mt-[10px]">
    ...
    <ul class="text-[9px] font-semibold w-[50vh] xl:text-[18px] lg:text-[16px] lg:w-[90vh] md:text-[13px] md:w-[90vh] sm:text-[12px] sm:w-[90vh] m-auto font-semibold">
      <li class="py-1">We, Rose Export Import Co.,Ltd was established in 2020. For the first time, we delivered some containers from Lanchabang Port to Mae Sot,from Mae Sot to Myawaddy smoothly.</li>
      <li class="py-1">There were only 2 warehouses in Yangon and Myawady in 2020.We implemented according to our core and got the customer's satisfaction feedback.</li>
      <li class="py-1">By 2022, we have expanded to 3 warehouses with one office each in Yangon and Myawady. With the trust of customers, I was able to grow my business and expand to a total of 6 warehouses and a large number of transport trucks. In addition, in 2023, the head office was expanded and built in Mae Sot, Thailand.</li>
      <li class="py-1">So now, due to my hard work and the trust of you guys, I will be called Rose in the import and export company and have achieved success.</li>
    </ul>
  </div>
