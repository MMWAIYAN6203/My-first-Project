<footer class="w-full lg:h-[220px] sm:h-[190px] bg-[color:var(--nav-color)] text-white">
    <div class="flex flex-row justify-between">
        <div class="flex flex-col gap-3 sm:px-[20px]">
            ...
            <div class="flex flex-col gap-1 sm:text-[11px] md:text-[14px] lg:text-[16px] xl:text-[16px]">
        ...
        <div class="xl:mt-[90px] sm:mt-[71px]">
            ...
            <ul class="xl:ms-[50px]  flex gap-[20px] sm:gap-[10px] lg:text-[20px] sm:text-[14px] wrapper">
                <li class="item sm:ms-[35px]"><a class="iconic"
                ...
                <li class="item"><a class="iconic" href="#"><i
                            class="icon fa-brands fa-facebook-messenger"></i></a></li>
            </ul>
            <br />
            <div
                class="text-white text-center text-[10px] xl:text-[16px] sm:text-[12px] md:text-[12px] lg:text-[14px] sm:ms-[-10px]">
