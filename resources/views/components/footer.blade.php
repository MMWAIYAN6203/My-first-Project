    ...
    <div class="flex flex-col items-center sm:flex sm:flex-row sm:justify-evenly md:flex md:flex-row md:justify-between lg:flex lg:flex-row lg:justify-between">
        ...
        <div class=" mt-[20px] xl:mt-[90px] sm:mt-[71px]">
            ...
            <ul class="xl:ms-[50px]  flex gap-[20px] sm:gap-[10px] lg:text-[20px] xl:text-[23px] sm:text-[14px] wrapper w-[19rem]">
                <li class="item sm:ms-[35px] ms-[30px] xl:ms-[8px] w-[3rem] h-[3rem]"><a class="iconic w-[3rem] h-[3rem]" href="https://www.facebook.com/Rose.imex.2023?mibextid=ZbWKwL"><i class="icon fa-brands fa-facebook"></i></a></li>
                <li class="item w-[3rem] h-[3rem]"><a class="iconic w-[3rem] h-[3rem]" href="viber://contact?number=+66951168205"><i class="icon fa-brands fa-viber"></i></a></li>
                <li class="item w-[3rem] h-[3rem]"><a class="iconic w-[3rem] h-[3rem]" href="#"><i class="icon fa-brands fa-line"></i></a></li>
                <li class="item w-[3rem] h-[3rem]"><a class="iconic w-[3rem] h-[3rem]" href="#"><i class="icon fa-brands fa-facebook-messenger"></i></a></li>
            </ul>
            <br />
