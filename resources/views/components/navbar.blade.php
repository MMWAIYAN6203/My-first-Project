<header class="bg-[color:var(--nav-color)] h-[102px] ">
    <nav
        ...
        <div
            ...
            <ul
                class="text-white flex md:flex-row flex-col m-auto md:items-center md:gap-[4vw] gap-5 text-[18px] mt-[120px] md:mt-[0px] lg:mt-[0px] xl:mt-[0px] xl:text-[25px] md:text-[13px]">
