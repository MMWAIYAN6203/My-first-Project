    ...
    <header class="bg-[color:var(--nav-color)] h-[80px]">
        <nav class="flex justify-between items-center w-full xl:px-[40px] sm:px-[30px] md:px-[20px] py-[20px] mx-auto">
            ...
            <div class="flex items-center gap-6">
                <div id='localSelector' class="text-white relative md:py-5 md:px-7 py-4 px-5 rounded-lg bg-[#6A85EE] cursor-pointer">
                ...
                <div id='localList' class="text-white absolute top-[103%] left-0 bg-[#07182E] w-full hidden">
                    <form action="{{ route('localization') }}" method="POST" class="">
                        ...
                        <div class='flex items-center gap-2 px-3 border-b border-gray-800'>
                            ...
                            <input type='submit' name='locale' value="Thai" class='hover:opacity-[0.8] w-full text-left px-3 py-4 block' />
                        </div>
                        <div class='flex items-center gap-2 px-3 border-b border-gray-800'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                            ...
                            <input type='submit' name='locale' value="En" class='hover:opacity-[0.8] w-full text-left px-3 py-4 block' />
                        </div>
                        <div class='flex items-center gap-2 px-3 border-b border-gray-800'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
                                ...
                                <path d="M27,4H5c-2.209,0-4,1.791-4,4V24c0,2.209,1.791,4,4,4H27c2.209,0,4-1.791,4-4V8c0-2.209-1.791-4-4-4Zm3,20c0,1.654-1.346,3-3,3H5c-1.654,0-3-1.346-3-3V8c0-1.654,1.346-3,3-3H27c1.654,0,3,1.346,3,3V24Z" opacity=".15"></path>
                                <path fill="#fff" d="M18.578 16.974L22.75 13.943 17.593 13.943 16 9.039 14.407 13.943 9.25 13.943 13.422 16.974 11.828 21.878 16 18.847 20.172 21.878 18.578 16.974z">
                                </path>
                                <path d="M27,5H5c-1.657,0-3,1.343-3,3v1c0-1.657,1.343-3,3-3H27c1.657,0,3,1.343,3,3v-1c0-1.657-1.343-3-3-3Z" fill="#fff" opacity=".2"></path>
                            </svg>
                            <input type='submit' name='locale' value="MM" class='hover:opacity-[0.8] w-full text-left px-3 py-4 block' />
                        </div>
                    </form>
                </div>
            </div>
