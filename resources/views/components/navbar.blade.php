...
<body class="font-[Poppins] ">
    <header class="bg-[color:var(--nav-color)] h-[100px] ">
        <nav
            class="flex justify-between items-center w-full xl:px-[40px] sm:px-[30px] md:px-[20px] py-[14px] px-[10px] mx-auto">
            <div>
                <a href="/">
            ...
            <div
                ...
                <ul
                    class="text-white flex md:flex-row flex-col m-auto md:items-center md:gap-[4vw] gap-5 text-[18px] mt-[120px] md:mt-[0px] lg:mt-[0px] xl:mt-[0px] xl:text-[25px]">
            ...
            <div class="flex items-center gap-[15px]">
                <div id='localSelector'
                    ...
                    <div class='flex flex-row items-center gap-4'>
                        ...
                        <div id='localList'
                            class="text-white absolute z-[5] top-[103%] left-0 bg-[#07182E] w-full hidden">
